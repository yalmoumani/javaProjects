package javaProjects.calculator;
...
class MyCalc extends WindowAdapter implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        String z, zt;
        // Creating the numerical buttons
        if (e.getSource() == b1) {
            zt = l1.getText();
            z = zt + "1";
            l1.setText(z);
        ...
        // Creating functionality for arithmetic operations
        ...
        if (e.getSource() == bsub) { // subtraction
            try {
                num1 = Double.parseDouble(l1.getText());
            } catch (NumberFormatException f) {
                l1.setText("Invalid Format");
        ...
        if (e.getSource() == bcalc) {
            try {
                ...
                l1.setText("Please enter a number");
                return;
            }
            if (check == 1)
                xd = num1 + num2;
        ...
        // For clearing the label and previous items
        if (e.getSource() == bclr) {
            num1 = 0;
            num2 = 0;
            check = 0;
